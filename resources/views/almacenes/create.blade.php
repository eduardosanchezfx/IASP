...
<div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12 text-center">
            <h1 class="m-0 text-dark"><i class="fas fa-plus-square"></i> Crear Almacen</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <form method="POST" action="{{ url('/Almacenes') }}">
              @csrf
              <!-- Timelime example  -->
              <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="col-md-4 form-group">
                              ...
                              <div class="col-md-4 form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" required placeholder="Almacen 01" name="name" id="name">
                                </div>
                                <!-- /.input group -->
                              </div>
                              <div class="col-md-4 form-group">
